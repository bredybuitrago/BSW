...
<head>
  ...
  <link rel="icon" href="<?php echo base_url(); ?>/assets/images/logo_sin_letras.png">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url(); ?>" class="nav-link">Contáctenos</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-none d-sm-inline-block" style="border: 1px solid #e1e1e1;">
        ...
        <a href="<?php echo base_url() ?>Login" class="nav-link"><i class="far fa-user"></i> Iniciar sesión</a>
      </li>
      <!-- Navbar Search -->
      <li class="nav-item">
